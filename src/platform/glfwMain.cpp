...
#pragma region window and opengl
	...
	const bool useHiddenHostWindow = true;
	...
	int w = useHiddenHostWindow ? 1 : 500;
	int h = useHiddenHostWindow ? 1 : 500;
	if (useHiddenHostWindow)
	{
		glfwWindowHint(GLFW_VISIBLE, GLFW_FALSE);
	}

	wind = glfwCreateWindow(w, h, "imgui_host", nullptr, nullptr);
	permaAssertComment(wind, "err creating glfw window");
